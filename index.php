...
if(isset($_POST['filtro']))
{
    ...
    $sql="select empleados.nombre_apellidos,empleados.extension,empleados.telefono_fijo,empleados.telefono_movil,empleados.email,area.nombre from (empleados inner join area on empleados.idArea=area.Id) where area.nombre='$dep' order by $ord;";
} 
else {
     //SQL para mostrar la tabla usuarios
    $sql="select empleados.nombre_apellidos,empleados.extension,empleados.telefono_fijo,empleados.telefono_movil,empleados.email,area.nombre from (empleados inner join area on empleados.idArea=area.Id) order by area.nombre;";
}
?>
 <?php
